...
<footer>
	<div id="footer">
		<div class="cd-tool visible-lg text-center">
			<?php if ($this->options->socialweixin) : ?><a id="weixin-img" class="cd-weixin"><span class="fa fa-weixin"></span>
					<div id="weixin-pic"><img src="<?php $this->options->socialweixin(); ?>"></div>
				</a><?php endif; ?>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 footer-list text-center">
					...
					<p>Copyright <?php echo date("Y"); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a>.
						<br>Powered by Ninvfeng <a href="http://www.typecho.org/" target="_blank">Typecho</a>
						Theme by <a href="https://github.com/vtrois/kratos" target="_blank" rel="nofollow">Kratos</a>
						<br><a href="http://www.beian.miit.gov.cn/" target="_blank" rel="nofollow">粤ICP备18022419号-1</a></p>
				</div>
			</div>
		</div>
	</div>
