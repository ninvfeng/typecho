...
<head>
	...
	<link rel='stylesheet' id='superfish-style-css' href='https://cdnjs.cloudflare.com/ajax/libs/superfish/1.7.9/css/superfish.min.css' type='text/css' media='all' />
			...
			<div class="kratos-start kratos-hero-2">
				...
				<div class="kratos-cover kratos-cover_2 text-center" style="background-image: url(<?php ($this->options->bannerimg) ? $this->options->bannerimg() : $this->options->themeUrl('images/background.jpg'); ?>);">
					<div class="desc desc2 animate-box">
						<h2><?php $this->options->logoTxt(); ?></h2><span><?php $this->options->description(); ?></span>
					</div>
				</div>
			</div>
